...
class example_t(object):
    ...
    def _encode_one(self, buf):
        ...
        buf.write(
            struct.pack(">%dh" % self.num_ranges, *self.ranges[: self.num_ranges])
        )
    ...
    def _decode_one(buf):
        ...
        self.ranges = struct.unpack(
            ">%dh" % self.num_ranges, buf.read(self.num_ranges * 2)
        )
    ...
    def _get_packed_fingerprint():
        if example_t._packed_fingerprint is None:
            example_t._packed_fingerprint = struct.pack(
                ">Q", example_t._get_hash_recursive([])
            )
